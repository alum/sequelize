...
module.exports = (function() {
  var QueryGenerator = {
    ...
    selectQuery: function(tableName, options) {
      ...
      var query = "SELECT " + options.attributes + " FROM " + table;
      ...
      if(options.limit) {
        if(options.offset) query += " LIMIT " + options.offset + ", " + options.limit
        else query += " LIMIT " + options.limit
      }
    ...
    insertQuery: function(tableName, attrValueHash) {
      ...
      var table = Utils.addTicks(tableName)
      var attributes = Utils._.keys(attrValueHash).map(function(attr){return Utils.addTicks(attr)}).join(",")
    ...
    updateQuery: function(tableName, values, where) {
      var table = Utils.addTicks(tableName)
      var values = Utils._.map(values, function(value, key){
